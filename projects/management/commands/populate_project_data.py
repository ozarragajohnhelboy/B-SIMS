...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        project_types = [
            {'name': 'Infrastructure Development', 'description': 'Road construction, bridge building, barangay hall improvements, and public facilities', 'color': '#3B82F6'},
            {'name': 'Livelihood Programs', 'description': 'Skills training, micro-enterprise development, and income-generating activities', 'color': '#10B981'},
            {'name': 'Health Services', 'description': 'Health center improvements, medical equipment, and community health programs', 'color': '#EF4444'},
            {'name': 'Education Support', 'description': 'School facilities, learning materials, and educational programs', 'color': '#8B5CF6'},
            {'name': 'Environmental Protection', 'description': 'Tree planting, waste management, and environmental conservation', 'color': '#059669'},
            {'name': 'Social Services', 'description': 'Senior citizen programs, PWD support, and social welfare initiatives', 'color': '#F59E0B'},
            {'name': 'Disaster Preparedness', 'description': 'Emergency response equipment, evacuation centers, and disaster training', 'color': '#DC2626'},
            {'name': 'Sports & Recreation', 'description': 'Sports facilities, playgrounds, and recreational activities', 'color': '#7C3AED'},
            {'name': 'Peace & Order', 'description': 'Security measures, community watch programs, and safety initiatives', 'color': '#374151'},
            {'name': 'Youth Development', 'description': 'Youth programs, leadership training, and skills development', 'color': '#EC4899'},
        ]
        ...
        projects_data = [
            ...
            {
                'title': 'Livelihood Skills Training Center',
                'description': 'Construction of a multi-purpose training center for livelihood programs and skills development',
                'project_type': 'Livelihood Programs',
                'status': 'planning',
                'priority': 'medium',
            ...
            },
            {
                ...
                'project_type': 'Environmental Protection',
                'status': 'ongoing',
                'priority': 'medium',
            ...
            {
                'title': 'Senior Citizen Center Construction',
                'description': 'Building a dedicated center for senior citizen programs and activities',
                'project_type': 'Social Services',
                'status': 'ongoing',
                'priority': 'high',
                'budget_allocated': Decimal('600000.00'),
                'budget_spent': Decimal('200000.00'),
                'progress_percentage': 40,
                'start_date': date.today() - timedelta(days=20),
                'end_date': date.today() + timedelta(days=80),
                'location': 'Barangay Plaza Area',
            },
            {
                'title': 'Disaster Response Equipment',
                'description': 'Procurement of emergency response equipment and training materials',
                'project_type': 'Disaster Preparedness',
                'status': 'planning',
                'priority': 'urgent',
                'budget_allocated': Decimal('400000.00'),
                'budget_spent': Decimal('0.00'),
                'progress_percentage': 0,
                'start_date': date.today() + timedelta(days=5),
                'end_date': date.today() + timedelta(days=60),
                'location': 'Barangay Emergency Center',
            },
        ]
